...
x_train_processed <- x_train_processed %>% select(-omega_max_to_min, -theta_min, -dist_max_to_min, -omega_mean_to_sd, -theta_sd_all)
x_test_processed <- x_test_processed %>% select(-omega_max_to_min, -theta_min, -dist_max_to_min -omega_mean_to_sd, -theta_sd_all)
# ########################################################################################################
# # use PCA
...
```{r}
tmp <- x_train_processed %>%  select(-series_id, -surface) %>% as.matrix()
dist <- classDist(tmp , x_train_processed$surface)

x_train_processed %>% filter(surface == "hard_tiles")
dim(tmp)
```

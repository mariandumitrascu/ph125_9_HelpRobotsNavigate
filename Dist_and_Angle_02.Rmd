...
results <- data.frame(series_id = x_train_for_train_ova$series_id, true_surface = x_train_for_train_ova$surface)
results_prob <- data.frame(series_id = x_train_for_train_ova$series_id, true_surface = x_train_for_train_ova$surface)
...
for(current_surface in surfaces$surface){
	...
	y_hat_prob <- predict(fit_model_current, x_train_for_test_ova_current, type = "prob")
	y_hat_new <- as.factor(ifelse(y_hat_prob[,1] > 0.25, current_surface, "the_rest"))
	...
	conf_matrix_new$overall["Accuracy"]
